...
public enum EFitnessType {
	...
	public Comparator<Individual> getComparator()
	{
		switch(this)
		{
		case MAXIMUM_BEST : return MaximizeComparator.instance; 
		case MINIMUM_BEST : return MinimizeComparator.instance;
		default : throw new IllegalStateException("Can't happen : invalid enum type "+this);
		}
	}
	...
	public boolean better(Individual i1,Individual i2)
	{
		switch (this)
		{
			case MAXIMUM_BEST : return i1.getFitness()>i2.getFitness();
			case MINIMUM_BEST : return i1.getFitness()<i2.getFitness();
			default : throw new IllegalStateException("Cant happen : invalid enum type");
		}
	}
