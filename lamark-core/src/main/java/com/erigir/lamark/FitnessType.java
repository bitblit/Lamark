...
public enum FitnessType {
     ...
     */
    public Comparator<ScoredGenome> getComparator() {
        switch (this) {
            case MAXIMUM_BEST:
     ...
     */
    public boolean better(ScoredGenome i1, ScoredGenome i2) {
        switch (this) {
            case MAXIMUM_BEST:
     ...
     * @author cweiss
     */
    static class MaximizeComparator implements Comparator<ScoredGenome> {
        /**
         * The static instance *
         */
         ...
         */
        public final int compare(ScoredGenome i1, ScoredGenome i2) {
            if (i1 == null || i2 == null) {
     ...
     * @author cweiss
     */
    static class MinimizeComparator implements Comparator<ScoredGenome> {
        /**
         * The static instance *
         */
