...
/**
 * Created by chrweiss on 6/10/14.
 */
public class MyNotate extends JPanel implements
        ActionListener,
        WindowListener, JMC {
    private Score score;
    //private Stave stave;
    ...
    public MyNotate(int locX, int locY) {
        this(new Phrase(), locX, locY);
        clearZoom();
    }

    public MyNotate(Phrase phr) {
        this(phr, 0, 0);
        clearZoom();
    }
    ...
    public MyNotate(Phrase phrase, int locX, int locY) {
    ...
    public MyNotate(Score score, int locX, int locY) {
    ...
    */
    ...
    public void openMidi() {
        Score s = new Score();
        FileDialog loadMidi = null;//new FileDialog(this, "Select a MIDI file.", FileDialog.LOAD);
    ...
    public void openJM() {
        FileDialog loadjm = null;//new FileDialog(this, "Select a jm score file.", FileDialog.LOAD);
    ...
    public void openJMXML() {
        FileDialog loadjmxml = null;//new FileDialog(this, "Select a jMusic XML score file.", FileDialog.LOAD);
    ...
    public void saveMidi() {
        FileDialog fd = null;//new FileDialog(this, "Save as a MIDI file...",FileDialog.SAVE);
        fd.show();
     ...
     */
    public void saveJM() {
        FileDialog fd = null;//new FileDialog(this, "Save as a jm file...",FileDialog.SAVE);
        fd.show();
    ...
    public void saveJMXML() {
        FileDialog fd = null;//new FileDialog(this, "Save as a jMusic XML file...",FileDialog.SAVE);
        fd.show();
