...
/**
 * This trait attempts to find repeating "themes" in the
...
public class RepeatingThemeTrait extends AbstractMusicTrait {
    @Override
    public double guardedFitness() {
        long s = System.currentTimeMillis();
        List deltas = getScoreAnalysis().getNoteDeltaList();
        ...
        //return Math.min(100.0,substringMultiple);
